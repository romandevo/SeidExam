  ...
  (function (n) {
    ...
    if (
      ...
      (respond.mediaQueriesSupported =
        n.matchMedia && n.matchMedia('only all').matches),
      !respond.mediaQueriesSupported)
    ) {
      var t = n.document,
        i = t.documentElement,
          ...
          for (t.length && (t += '/'), y && (s = 1); h < s; h++)
            for (
              ...
              (r = l[f]),
                e.push({
                  media:
                    (r.split('(')[0].match(/(only\s+)?([a-zA-Z]+)\s?/) &&
                      RegExp.$2) ||
                    'all',
                  rules: u.length - 1,
          ...
          for (o in d)
            (h = t.createElement('style')),
              ...
              h.styleSheet
                ...
                : h.appendChild(t.createTextNode(g)),
              r.push(h);
        },
        nt = function (n, t) {
          var i = tt();
      ...
      respond.update = y;
      n.addEventListener
        ? n.addEventListener('resize', d, !1)
        : n.attachEvent && n.attachEvent('onresize', d);
    }
  })(this);
